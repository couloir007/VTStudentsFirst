...
const settings = {
  title: 'Components/Action Section',
};
...
export const Default = {
  ...
  args: {
    ...
    section_headline: 'Four ways to make an <em>impact today.</em>',
    ...
    steps: [
      {
        ...
        body: 'Send a personal message to your Vermont House and Senate members. Personal messages carry far more weight than form letters.',
        cta: { url: '#', title: 'Write to My Legislators' },
      },
      {
        ...
        cta: { url: '#', title: 'Get Board Template' },
      },
      {
        headline: 'Spread the Word',
        body: 'Share on Facebook, Front Porch Forum, or Instagram. Use the ready-made posts — or write your own.',
        cta: { url: '#', title: 'Get Social Posts' },
      },
      {
        ...
        cta: { url: '#', title: 'Get LTE Templates' },
      },
    ],
    toolkit: {
          ...
          items: [
            {
              ...
              content: 'Rural Vermont doesn\'t deserve to have its education system targeted. Proposals in the House Education Committee would cut out the independent schools that have served us for generations. Contact your legislators today. #VTStudentsFirst #VTEd',
            },
            {
              id: 'social-2',
              title: 'Post 2 — Data',
              content: 'Independent school students make up 4% of Vermont\'s student population and just 3% of Education Fund spending. Districts with school choice spend LESS per pupil than the state average. These schools aren\'t the problem. #VTStudentsFirst',
            },
            {
              id: 'social-3',
              title: 'Post 3 — Family',
              content: 'My child is not a seat to be filled. Proposals in the House Education Committee seek to make public schools the "default," allowing tuition to independent schools only as a rare exception. Let\'s keep our choice. #VTStudentsFirst',
            },
            {
              id: 'social-4',
              title: 'Post 4 — Academies',
              content: 'St. Johnsbury Academy, Lyndon Institute, Burr and Burton, Thetford Academy — these are not exceptions. They are the system. Let\'s keep our communities vibrant. #VTStudentsFirst',
            },
          ],
        },
        {
