  ...
  args: {
    ...
    issue_cards: [
      ...
      },
      {
        ...
        body: 'Explicit statutory protection for tuitioning access in non-operating towns, plus clear statewide accountability guardrails for any school receiving public tuition dollars.',
        variant: 'urgent',
      },
      {
