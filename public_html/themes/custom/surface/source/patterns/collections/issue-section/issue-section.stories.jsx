...
export const Default = {
  ...
  args: {
    ...
    lead_text: 'In Vermont, over 90 towns have no public high school of their own. Tuitioning — the right of families to choose an approved school and have tuition paid by their town — is how these communities provide public education. For generations, students in Sutton, Newark, and dozens of other rural towns have attended St. Johnsbury Academy, Lyndon Institute, Burr and Burton Academy, Thetford Academy, and other regional schools through this system.',
