...
const settings = {
  title: 'Collections/Positions Section',
};
...
export const Default = {
  ...
  args: {
    ...
    positions: [
      ...
      {
        headline: 'Governance cannot be a backdoor to end tuitioning',
        body: 'If consolidation or restructuring proceeds, statute must explicitly prevent governance changes from being used to eliminate family choice in non-operating towns. The protection must be durable.',
      },
    ],
  },
};
