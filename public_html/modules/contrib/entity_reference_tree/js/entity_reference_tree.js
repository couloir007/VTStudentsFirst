  ...
  Drupal.behaviors.entityReferenceTree = {
    attach: function(context, settings) {
      ...
      entityJSTree.forEach(function(entityTree) {
          ...
          const worker = treeContainer.attr("worker");
          const disableAnimation = treeContainer.attr("disable_animation");
          const forceText = treeContainer.attr("force_text");
          ...
          if (widgetElement.length) {
            ...
            treeContainer.jstree({
              core: {
                ...
                worker: Boolean(Number(worker)),
                animation: Boolean(Number(disableAnimation)) ? false : 200,
                force_text: Boolean(Number(forceText)),
