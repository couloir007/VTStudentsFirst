...
class SearchForm extends FormBase {
   ...
   * {@inheritdoc}
   */
  public function buildForm(array $form, FormStateInterface $form_state, $field_edit_id = '', $bundles = '', $entity_type = '', $theme = 'default', $dots = FALSE, $worker = TRUE, $disableAnimation = FALSE, $forceText = FALSE, $limit = -1) {
    ...
    $form['tree_container'] = [
      ...
      '#attributes' => [
        ...
        'disable_animation' => intval($disableAnimation),
        'force_text' => intval($forceText),
      ],
    ];
    // Submit button.
    ...
    $form['#attached']['drupalSettings'] = [
      'data_url_' . $field_edit_id => Url::fromRoute('entity_reference_tree.json', [
        ...
        'bundles' => $bundles,
      ])->toString() . '?token=' . \Drupal::csrfToken()->get($this->buildTreeJsonTokenValue($entity_type, $bundles)),
