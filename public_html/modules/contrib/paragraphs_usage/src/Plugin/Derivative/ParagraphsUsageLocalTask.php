...
namespace Drupal\paragraphs_usage\Plugin\Derivative;
 ...
 */
class ParagraphsUsageLocalTask extends DeriverBase implements ContainerDeriverInterface {
  ...
  public function getDerivativeDefinitions($base_plugin_definition): array {
    ...
    if (!empty($template_key)) {
      $this->derivatives[$entity_type_id . '.paragraphs_usage'] = [
        'route_name' => 'entity.' . $entity_type_id . '.paragraphs_usage',
        'title' => $this->t('Usage'),
