...
class EstimatedReadTimeWidget extends WidgetBase {
  ...
  public function formElement(FieldItemListInterface $items, $delta, array $element, array &$form, FormStateInterface $form_state): array {
    ...
    /** @var \Drupal\estimated_read_time\Plugin\Field\FieldType\EstimatedReadTimeItem $item */
    $item = $items[$delta];

    $element['auto'] = [
      '#type' => 'checkbox',
      '#title' => $this->t('Automatically estimate read time'),
      '#default_value' => (bool) ($item->auto ?? TRUE),
