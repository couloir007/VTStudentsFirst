((Drupal, once) => {
  ...
  Drupal.surfaceSearch = {
    init: function (context) {
      ...
      // Search toggle
      once('surfaceSearchToggle', '[data-drupal-selector="search-open"]', context).forEach((el) => {
      ...
      // Close modal
      once('surfaceCloseModal', '[data-drupal-selector="search-close"]', context).forEach((el) => {
        el.addEventListener('click', (e) => {
          e.preventDefault();
          this.collapseSearch();
        });
